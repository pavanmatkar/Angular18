...
@Component({
  ...
  template: `
    ...
    <button
      class="fixed top-4 left-8 z-50 bg-blue-500 text-white p-2 rounded-md shadow-md md:hidden hover:bg-blue-600 transition-colors"
      (click)="toggleSidebar()"
    >
      ☰
    </button>
    <aside
      class="bg-white w-80 min-h-screen pt-8 shadow-sm fixed md:relative z-40 transform transition-transform duration-300"
      [ngClass]="{
